...
public class AppointmentDAO {
    ...
    public boolean addAppointment(Appointment app) {
        String sql = "INSERT INTO appointments (appointment_id, doctor_id, patient_id,status) " +
                "VALUES (?, ?, ?, ?, ?, ?,'pending')";
    ...
    public boolean confirmAppointment(int appointmentId, LocalDateTime newScheduledDate) {
        String sql = "UPDATE appointments SET date_scheduld = ?,status = 'confirmed' WHERE appointment_id = ?";
